...
/**
 * Test case for class PoiCom\PcEventScheduler\Controller\EventController.
 *
...
class EventControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \PoiCom\PcEventScheduler\Controller\EventController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('PoiCom\\PcEventScheduler\\Controller\\EventController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllEventsFromRepositoryAndAssignsThemToView()
	{
		...
		$eventRepository = $this->getMock('PoiCom\\PcEventScheduler\\Domain\\Repository\\EventRepository', array('findAll'), array(), '', FALSE);
	...
	public function createActionAddsTheGivenEventToEventRepository()
	{
		...
		$eventRepository = $this->getMock('PoiCom\\PcEventScheduler\\Domain\\Repository\\EventRepository', array('add'), array(), '', FALSE);
	...
	public function updateActionUpdatesTheGivenEventInEventRepository()
	{
		...
		$eventRepository = $this->getMock('PoiCom\\PcEventScheduler\\Domain\\Repository\\EventRepository', array('update'), array(), '', FALSE);
	...
	public function deleteActionRemovesTheGivenEventFromEventRepository()
	{
		...
		$eventRepository = $this->getMock('PoiCom\\PcEventScheduler\\Domain\\Repository\\EventRepository', array('remove'), array(), '', FALSE);
