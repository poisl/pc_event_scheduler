...
/**
 * Test case for class \PoiCom\PcEventScheduler\Domain\Model\Holiday.
 *
...
{
	/**
	 * @var \PoiCom\PcEventScheduler\Domain\Model\Holiday
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = new \PoiCom\PcEventScheduler\Domain\Model\Holiday();
	}
